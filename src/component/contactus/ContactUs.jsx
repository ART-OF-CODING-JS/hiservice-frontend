...
It usually takes us up to 48 hours to get back to you. </p>
			...
			<label for="checkcontact" className="contactbutton"><div className="mail"></div></label>
      <input id="checkcontact" type="checkbox"/>
	
			<form action="" method="post" className="contactform"  onSubmit={sendMessage}>
				<p className="input_wrapper"><input type="text" name="contact_nom"   placeholder="Your Name *" id ="contact_nom"  ref={nameRef} required
                      data-validation-required-message="Please enter your name."/>
        <label for="contact_nom">NAME</label></p>
				<p className="input_wrapper"><input type="text" name="contact_email"   placeholder="Your Email *" id ="contact_email"  ref={emailRef}  required
                      data-validation-required-message="Please enter your email address."/>
          <label for="contact_email">EMAIL</label></p>
				
				<p className="textarea_wrapper">
          <textarea name="contact_message" id="contact_message"  ref={msgRef}></textarea></p>
				<p className="submit_wrapper"> <input type="submit" value="Send Message"/></p>			
			</form>
	</article>
</section>
</>
