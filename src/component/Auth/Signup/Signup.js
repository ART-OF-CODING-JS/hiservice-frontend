...
import { MDBBtn, MDBInput,MDBCard,MDBContainer,MDBRow ,MDBCol,MDBCardImage,MDBCardBody
        ...
        <MDBRow className='g-0'>
          ...
          <MDBCol md='10'>
            <MDBCardBody className='d-flex flex-column'>
              ...
              <MDBInput className="" wrapperClass='mb-4' label='Username' id='formControlLg' type='text' size="lg"/>
              ...
              <MDBBtn className="mb-4 px-5 btn-com" color='dark' size='lg'>Singup</MDBBtn>
