    ...
    {allServices.map(ele=>
        ...
        <div className='service-card'>
                <div className="image-card">
                    <Link to={`/Services/${ele.id}`}><img className='img' alt='service' src={ele.image}/></Link>
                </div>
                <div className="card-info">
                    ...
                    <div className=''>
                        ...
                        <button className="add-fav btn-card">Add to Favorite <i className="fa-regular fa-heart"></i></button>
                        <Reports id={ele.id}/>
                    </div>
                </div>
        </div>
